...
public class GuiAdvancement extends Gui
{
    ...
    public void func_191821_a(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_)
    {
        ...
        if (flag1)
        {
            ...
            {
                this.field_191833_k.fontRendererObj.drawString((String)this.field_192997_l.get(k1), (float)(i1 + 5), (float)(l + 26 - j1 + 7 + k1 * this.field_191833_k.fontRendererObj.FONT_HEIGHT), -5592406, false);
            }
        }
        else
        {
            ...
            {
                this.field_191833_k.fontRendererObj.drawString((String)this.field_192997_l.get(l1), (float)(i1 + 5), (float)(p_191821_2_ + this.field_191826_p + 9 + 17 + l1 * this.field_191833_k.fontRendererObj.FONT_HEIGHT), -5592406, false);
            }
        }
