...
public class LowerStringMap<V> implements Map<String, V>
{
    ...
    {
        return (V)this.internalMap.get(p_get_1_.toString().toLowerCase(Locale.ROOT));
    }

    public V put(String p_put_1_, V p_put_2_)
    {
        return (V)this.internalMap.put(p_put_1_.toLowerCase(Locale.ROOT), p_put_2_);
    }

    public V remove(Object p_remove_1_)
    {
        return (V)this.internalMap.remove(p_remove_1_.toString().toLowerCase(Locale.ROOT));
    }
